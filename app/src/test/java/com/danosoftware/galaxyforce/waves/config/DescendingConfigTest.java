...
public class DescendingConfigTest {
    ...
    public void shouldCreateBasicConfiguredDescender() {
        DescendingConfig config = DescendingConfig
                .builder()
        ...
        assertThat(config.getAlienType(), equalTo(AlienType.DESCENDING));
        ...
        assertThat(aliens.get(0) instanceof DescendingAlien, is(true));
    }

    @Test
    public void shouldCreateFullyConfiguredDescender() {
        DescendingConfig config = DescendingConfig
                .builder()
                .alienCharacter(AlienCharacter.OCTOPUS)
                .energy(10)
