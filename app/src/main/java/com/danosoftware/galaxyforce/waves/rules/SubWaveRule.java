 ...
 * <p>
 * Each sub-wave property contains enough data to create a sub-wave of aliens that follow some
 * rules.
 */
public enum SubWaveRule {

  /**
   * Asteroids that fall from top to bottom at random x positions and random speeds
   */
  ASTEROIDS(
