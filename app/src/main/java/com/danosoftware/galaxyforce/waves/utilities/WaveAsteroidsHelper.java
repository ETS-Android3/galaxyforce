...
public class WaveAsteroidsHelper {
  ...
  /**
   * Create an asteroid field with asteroids at random positions, moving at specific angles. On
   * explosion, each asteroid will spawn two mini-asteroids at 45 degree angles
   */
  ...
  /**
   * Create asteroids that start off screen: top, bottom, left and right. The angles are adjusted so
   * asteroids move towards centre of screen.
   */
