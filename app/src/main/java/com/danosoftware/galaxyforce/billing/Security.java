...
class Security {
     ...
     * private key. The data also contains the PurchaseState and product
     * ID of the purchase.
     *
    ...
    public static boolean verifyPurchase(String base64PublicKey, String signedData, String signature) {
        if (TextUtils.isEmpty(signedData) || TextUtils.isEmpty(base64PublicKey) || TextUtils.isEmpty(signature)) {
             ...
             *
             * FIXME - Danny - manual override for testing in development mode.
             * Eill normally fail in dev mode due to lack of signature. Override
             * by always returning true when developing.
             */
            if (BuildConfig.DEBUG) {
                Log.w(GameConstants.LOG_TAG, "DEVELOPMENT: Manually overriding verifyPurchase()");
                return true;
            } else {
                return false;
            }
