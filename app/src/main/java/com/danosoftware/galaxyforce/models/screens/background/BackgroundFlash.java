...
/**
 * Provides the colour progression to provide a background flash. Starts with a white flash for a
 * short duration and then fades to the normal background colour.
 */
