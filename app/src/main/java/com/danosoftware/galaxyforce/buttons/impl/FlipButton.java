...
/**
 * Represents a flip button. Calls game model when pressed.
 */
public class FlipButton implements SpriteButton
{

    /* Constants for the flip button's position */
    public static final int FLIP_BUTTON_X = GameConstants.GAME_WIDTH - 50 - 10;
    public static final int FLIP_BUTTON_Y = 50 + 10;
    ...
    public FlipButton(GameHandler model, Controller controller, ISpriteIdentifier spriteButtonUp, ISpriteIdentifier spriteButtonDown)
    {
        this.model = model;
        ...
        this.buttonSprite = new ButtonRectangle(FLIP_BUTTON_X, FLIP_BUTTON_Y, spriteButtonUp, 10, 10);
